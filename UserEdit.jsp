...
<title>Alacriti Infosystems Pvt Ltd</title><script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
        ...
        <% }
        		...
        		%>
       			 ...
       			 <li><a href="Profile.jsp">Profile</a></li>
       			        			 <li class="active"><a href="EditProfile.jsp">Update Profile</a></li>
...
String uid=null,fullname=null,emailad=null,mobile=null,birthday=null,passworda=null;
try 
{
	...
	ResultSet profileSet=stmt.executeQuery("select * from hakit_AL183 where user_name='"+uname+"'");
	if(profileSet.next()){
		uid=profileSet.getString("user_id");
		fullname=profileSet.getString("user_fullname");
		emailad=profileSet.getString("user_email");
		mobile=profileSet.getString("user_mobileno");
		birthday=profileSet.getString("user_birthday");
		passworda=profileSet.getString("user_password");
	}
}catch(Exception e){
...
<div class="panel panel-primary" align="center">
  <div class="panel-heading">
    <h3 class="panel-title"><b><%= uname %></b> : Update Information</h3>
  </div>
  <div class="panel-body">
   <br><br>
  <form class="form-horizontal" name="RegistrationForm" action="UpdateUserDetails.jsp" method="POST">
  
  <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">User ID</label>
    <div class="col-sm-6">
      <input type="text" class="form-control" id="user_id" name="user_id" value="<%=uid %>" required >
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="text" class="form-control" id="user_name" name="user_name" value="<%=uname %>" required >
    </div>
  </div>
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">Full Name</label>
    <div class="col-sm-6">
      <input type="text" class="form-control" id="user_fullname" name="user_fullname" value="<%=fullname %>" required>
    </div>
  </div>
   <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Password</label>
    <div class="col-sm-6">
      <input type="password" class="form-control" id="user_password" name="user_password" value="<%=passworda %>" required>
    </div>
  </div>
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">Birthday</label>
    <div class="col-sm-6">
      <input type="text" class="form-control" id="user_birthday" name="user_birthday" value="<%=birthday %>" required>
    </div>
  </div>
   <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Email Address</label>
    <div class="col-sm-6">
      <input type="email" class="form-control" id="user_email" name="user_email" value="<%=emailad %>" required>
    </div>
  </div>
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">Mobile Number</label>
    <div class="col-sm-6">
      <input type="text" class="form-control" id="user_mobileno" name="user_mobileno" value="<%=mobile %>" required>
    </div>
  </div>
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-6">
      <button type="submit" class="btn btn-success">Confirm & Update the infromation</button>
    </div>
  </div>
</form>
</div>
