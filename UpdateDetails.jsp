...
<%
		String userName=(String)session.getAttribute("username");
    		...
    		try 
            {
                ...
                String query="update hakit_AL183 set user_fullname='"+user_fullname+"' , user_email='"+user_email+"' ,  user_mobileno='"+user_mobileno+"' , user_birthday='"+user_birthday+"',user_password='"+user_password+"' where user_name='"+userName+"'";
