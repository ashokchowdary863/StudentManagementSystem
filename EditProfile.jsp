...
<div class="panel panel-primary" align="center">
  <div class="panel-heading">
    <h3 class="panel-title"><b><%= userName %></b> : Update Information</h3>
  </div>
  <div class="panel-body">
   <br><br>
  <form class="form-horizontal" name="RegistrationForm" action="UpdateDetails.jsp" method="POST">
  
  <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">User ID</label>
    <div class="col-sm-6">
      <input type="text" class="form-control" id="user_id" name="user_id" value="<%=uid %>" required disabled>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="text" class="form-control" id="user_name" name="user_name" value="<%=userName %>" required disabled>
    </div>
  </div>
  <div class="form-group">
