      ...
      <ul class="nav navbar-nav">
        ...
        <% }
        		...
        		%>
       			 ...
       			 <li  class="active"><a href="EditUserDetails.jsp">Update/Delete User</a></li>
					<li class="dropdown">
    		...
    		<table class="table table-bordered">
    			...
    			try 
                {
                    ...
                    Connection con = DriverManager.getConnection("jdbc:mysql://192.168.35.103:3315/trainee_dev", "trainee_dev", "trainee_dev");
               		...
               		ResultSet listSet=stmt.executeQuery("select * from hakit_AL183");
               		while(listSet.next()){
               			tableOutput+= "<tr>";
               			...
               			tableOutput+= "<td><a href='UserEdit.jsp?user="+listSet.getString("user_name")+"'><span class='glyphicon glyphicon-edit' aria-hidden='true'></span></a></td>";
               			tableOutput+= "<td><a href='UserDelete.jsp?user="+listSet.getString("user_name")+"'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a></td>";
               			tableOutput+= "</tr>";
               		}
               		stmt.close();
               		con.close();
