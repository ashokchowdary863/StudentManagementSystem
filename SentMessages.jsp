...
<div class="panel panel-warning">
  <div class="panel-heading">
    <h3 class="panel-title"><b><%=userName %>'s Sent Box</b></h3>
  </div>
  <div class="panel-body">
    			...
    			try 
                {
                    ...
                    Connection con = DriverManager.getConnection("jdbc:mysql://192.168.35.103:3315/trainee_dev", "trainee_dev", "trainee_dev");
               		...
               		ResultSet listSet=stmt.executeQuery("select * from hakit_messages_AL183 where sender='"+userName+"' order by date");
               		while(listSet.next()){
               			messageOutput+= "<div class='panel panel-success'>";
               			messageOutput+="<div class='panel-heading'><h3 class='panel-title'>To : "+listSet.getString("receiver")+"</h3>";
               			messageOutput+="</div>";
